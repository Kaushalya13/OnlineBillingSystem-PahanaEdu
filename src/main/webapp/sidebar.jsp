...
--%>
<%-- Created by IntelliJ IDEA. User: Niwanthi --%>
<%
...
<style>
  ...
  .logout-button:hover {
    ...
    box-shadow: 0 6px 16px rgba(128, 90, 213, 0.3);
  }
</style>
...
<aside id="sidebar" class="sidebar-container w-64 text-gray-900 flex-shrink-0 min-h-screen fixed flex-col z-40 md:flex">
  ...
  <div class="p-6 border-t border-gray-200">
    <button class="logout-button w-full flex items-center justify-center text-white font-semibold py-3 px-4 rounded-lg transition duration-200 shadow-md">
